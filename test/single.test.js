...
test('escape html', () => {
	...
	expect(markdown.toHTML('```html\n\n<b>test</b>\n```'))
		.toBe('<pre><code class="hljs language-html"><span class="hljs-tag">&lt;<span class="hljs-name">b</span>&gt;</span>test<span class="hljs-tag">&lt;/<span class="hljs-name">b</span>&gt;</span></code></pre>');
});
